...
{% macro flatten_run_result(run_result) %}
    ...
    {% set flatten_run_result_dict = {
        ...
        'name': node.get('name'),
        'message': truncate_text(run_result_dict.get('message'), elementary.get_config_var('long_string_size') - 1000),
        ...
        'compiled_code': truncate_text(elementary.get_compiled_code(node, as_column_value=true), elementary.get_config_var('long_string_size') - 1000),
